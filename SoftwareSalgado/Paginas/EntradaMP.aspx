...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <asp:Label runat="server" CssClass="card-body h4" Text="Matéria-Prima"></asp:Label>
                <br />

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <asp:Label runat="server" Text="Entrada de Matéria-Prima" CssClass="col-sm-9 col-form-label"></asp:Label>
                            <div class="col-sm-9">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <asp:Label runat="server" Text="Quantidade" CssClass="col-sm-9 col-form-label"></asp:Label>
